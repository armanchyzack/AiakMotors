...
<div class="card">
    ...
    <div class="card-body row">
      <h5 class="card-title col-6">All Product</h5>
        <span class="col-6 text-end"><a href="<?php echo e(route('car.store')); ?>" class="btn btn-success btn-sm">Add Product</a></span>
        <hr>
      <div class="table-responsive">
        <table class="display table">
            ...
            <tbody class="table-group-divider">
                <tr>
                  <th scope="row">sdasd</th>
                  <td style="height: 2rem; width:1rem"><img style="width: 100%; height:100%" src="sdasd" alt=""></td>
                  <td>asdsd</td>
                  <td>
